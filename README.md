...
- **Linux launch support** - Import Steam libraries, launch native/Linux Steam games, run Windows executables through Wine, and register `lunabox://` shortcuts
...
- [msys2](https://www.msys2.org/) and [NSIS](https://nsis.sourceforge.io/Main_Page) for Windows installers
- Linux desktop builds require the Wails WebKitGTK/GTK development packages for your distribution
...
# Build locally using script (Linux)
...
- [x] Basic Linux/macOS platform support
