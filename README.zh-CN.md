...
- **Linux 启动支持** - 支持导入 Steam 库、启动 Linux/Steam 游戏、通过 Wine 启动 Windows 可执行文件，并注册 `lunabox://` 快捷启动
...
- Windows 安装包需要 [msys2](https://www.msys2.org/) 和 [NSIS](https://nsis.sourceforge.io/Main_Page)
- Linux 桌面构建需要安装发行版对应的 Wails WebKitGTK/GTK 开发包
