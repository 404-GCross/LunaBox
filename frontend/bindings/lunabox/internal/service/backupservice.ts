...
export function CreateBackup(
  gameID: string,
): $CancellablePromise<models$0.GameBackup | null> {
 ...
 * TODO: 前端提供此功能的按钮
 */
export function DownloadCloudDBBackup(
  cloudKey: string,
): $CancellablePromise<string> {
 ...
 */
export function ExchangeOneDriveCode(
  code: string,
): $CancellablePromise<string> {
 ...
 */
export function GetCloudDBBackups(): $CancellablePromise<
  vo$0.CloudBackupItem[]
> {
 ...
 */
export function GetCloudGameBackups(
  gameID: string,
): $CancellablePromise<vo$0.CloudBackupItem[]> {
 ...
 */
export function GetGameBackups(
  gameID: string,
): $CancellablePromise<models$0.GameBackup[]> {
 ...
 */
export function GetUmbraUserProfile(
  config: appconf$0.AppConfig,
): $CancellablePromise<vo$0.UmbraUserProfile | null> {
 ...
 */
export function ScheduleDBRestore(
  backupPath: string,
): $CancellablePromise<void> {
 ...
 */
export function ScheduleDBRestoreFromCloud(
  cloudKey: string,
): $CancellablePromise<void> {
 ...
 */
export function ScheduleFullDataRestore(
  backupPath: string,
): $CancellablePromise<void> {
 ...
 */
export function SetupCloudBackup(
  password: string,
): $CancellablePromise<string> {
 ...
 */
export function StartUmbraAuth(
  config: appconf$0.AppConfig,
): $CancellablePromise<void> {
 ...
 */
export function TestOneDriveConnection(
  config: appconf$0.AppConfig,
): $CancellablePromise<void> {
 ...
 */
export function TestUmbraConnection(
  config: appconf$0.AppConfig,
): $CancellablePromise<void> {
 ...
 */
export function UploadDBBackupToCloud(
  backupPath: string,
): $CancellablePromise<void> {
 ...
 */
export function UploadGameBackupToCloud(
  gameID: string,
  backupPath: string,
): $CancellablePromise<void> {
...
const $$createType10 = vo$0.UmbraUserProfile.createFrom;
