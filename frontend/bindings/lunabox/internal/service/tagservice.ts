 ...
 */
export function FilterExistingTagNames(
  names: string[],
 ...
 */
export function GetGameIDsByTag(
  tagName: string,
): $CancellablePromise<string[]> {
 ...
 */
export function GetTagsByGame(
  gameID: string,
): $CancellablePromise<models$0.GameTag[]> {
...
export function Init(
  ...
  return $Call.ByID(3443841159, db, config);
}

/**
 * SearchTagsInLibrary 搜索库中匹配的 tag 名称（用于游戏库筛选）
 */
export function SearchTagsInLibrary(
  query: string,
): $CancellablePromise<string[]> {
