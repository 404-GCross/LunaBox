    ...
    <div className="space-y-6">
      <div className="flex items-center gap-1">
        ...
        <Popover className="relative">
          ...
          <PopoverPanel
            anchor="bottom start"
            className="z-[var(--desktop-layer-dropdown)] mt-2 w-80 max-w-[calc(100vw-2rem)] rounded-xl border border-brand-200 bg-white p-4 shadow-xl focus:outline-none dark:border-brand-700 dark:bg-brand-800 data-glass:bg-white/90 data-glass:backdrop-blur-20 data-glass:dark:bg-brand-900/90 [--anchor-gap:8px]"
          >
