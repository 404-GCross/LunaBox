...
export function CancelUmbraAuth() {
  return window['go']['service']['BackupService']['CancelUmbraAuth']();
}
...
export function LogoutUmbra(arg1) {
  return window['go']['service']['BackupService']['LogoutUmbra'](arg1);
}
