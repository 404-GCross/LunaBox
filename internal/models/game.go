...
type Game struct {
	...
	SourceType              enums.SourceType     `json:"source_type"` // 兼容字段：首选元数据来源
	PreferredMetadataSource enums.SourceType     `json:"preferred_metadata_source"`
	MetadataSources         []GameMetadataSource `json:"metadata_sources"`
	CachedAt                time.Time            `json:"cached_at"`
	SourceID                string               `json:"source_id"` // 兼容字段：首选元数据来源 ID
